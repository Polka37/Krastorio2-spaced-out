...
data_util.remove_research_unit_ingredient("radar", "chemical-science-pack")
...
data.raw.technology["kr-logistic-4"].hidden = true
data.raw.technology["kr-logistic-4"].hidden_in_factoriopedia = true
